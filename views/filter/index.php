            ...
            <article class="post">
                ...
                <div class="post-content">
                    ...
                    <div class="social-share">
                        <span class="social-share-title pull-left text-capitalize">By <a href="<?= Url::toRoute(['filter/index', 'author' => $article->author->id]); ?>"><?= $article->author->name ?></a> On <?= $article->getDate(); ?></span>
